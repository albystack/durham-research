...
Production was authorized on 21 August 2026 after the completed validation
stages. This authorization does not
...
The retained environment blocks, full cutoff/weighting table, diagnostics, and
checksums are in
